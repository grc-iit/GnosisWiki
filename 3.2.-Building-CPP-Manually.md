# 3.2.1. Building CPP Manually

In this section, we have four objectives:
...
1. [database_lib.cc](https://github.com/scs-lab/scs-tutorial/blob/main/3.3.buliding_cpp/src/database_lib.cc) implements the CRUD operations.
2. [grocery_db.cc](https://github.com/scs-lab/scs-tutorial/blob/main/3.3.buliding_cpp/src/movie_db.cc) implements the grocery database on top of CRUD
3. [movies_db.cc](https://github.com/scs-lab/scs-tutorial/blob/main/3.3.buliding_cpp/src/movie_db.cc) implements the movie database on top of CRUD

## 3.2.2. Setup + Repo Structure

Change to the Shared Libraries tutorial.
```bash
...
This is the typical way a C++ repo is structured. Thi is because in many cases
...
## 3.2.3. Database Library Header File
```cpp
...
## 3.2.5. Movies Database Source File
